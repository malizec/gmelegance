 ...
 <?php
	$page=$_GET['page'];
    echo "<ul>";
    echo "<li class=\"nav-link\"><a  class=\"links\" href=\"index.php?page=onama\">Početna</a></li>";
    echo "<li id=\"nav-link-muzjaci\" class=\"nav-link"; if($page=='muzjaci'){echo"-active\"><a  class=\"links-active\"";}else{ echo"\"><a  class=\"links\"";
	}  echo" href=\"index.php?page=muzjaci\">Mužjaci</a>";
    ...
    echo "     </ul>";
    echo "</li>";
    echo "<li id=\"nav-link-zenke\" class=\"nav-link"; if($page=='zenke'){echo"-active\"><a  class=\"links-active\"";}else{ echo"\"><a  class=\"links\"";
	}  echo" href=\"index.php?page=zenke\">Ženke</a>";
    ...
    echo "     </ul>";
    echo "</li>";
    echo "<li id=\"nav-link-stenci\" class=\"nav-link"; if($page=='stenci'){echo"-active\"><a  class=\"links-active\"";}else{ echo"\"><a  class=\"links\"";
	}  echo" href=\"index.php?page=stenci\">Štenci</a>";
    echo "     <ul id=\"menu-ul-2-stenci\">";
    echo "          <li class=\"menu-ul-2-stenci\"><a href=\"index.php?page=stenci\" class=\"links\">Štenci</a></li>";
    echo "      </ul>";
    echo "</li>";
    echo "<li id=\"nav-link\" class=\"nav-link"; if($page=='galerija'){echo"-active\"><a  class=\"links-active\"";}else{ echo"\"><a  class=\"links\"";
	}  echo" href=\"index.php?page=galerija\">Galerija</a>";
    echo "</li>";
    echo "<li class=\"nav-link"; if($page=='onama'){echo"-active\"><a  class=\"links-active\"";}else{ echo"\"><a  class=\"links\"";
	}  echo" href=\"index.php?page=onama\">O nama</a></li>";
    echo "<li class=\"nav-link"; if($page=='kontakt'){echo"-active\"><a  class=\"links-active\"";}else{ echo"\"><a  class=\"links\"";
	} echo" href=\"index.php?page=kontakt\">Kontakt</a></li>";
    echo "</ul>";
?>
